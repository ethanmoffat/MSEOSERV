...
/* $Id: socket.hpp 490 2015-11-18 10:46:34Z sausage $
...
class Socket_Exception : public std::exception
{
	...
	public:
		...
		virtual const char *what() const { return "Socket_Exception"; }
...
class Socket_InitFailed : public Socket_Exception
{
	public:
		...
		const char *what() const { return "Socket_InitFailed"; }
};
...
class Socket_BindFailed : public Socket_Exception
{
	public:
		...
		const char *what() const { return "Socket_BindFailed"; }
};
...
class Socket_ListenFailed : public Socket_Exception
{
	public:
		...
		const char *what() const { return "Socket_ListenFailed"; }
};
...
class Socket_SelectFailed : public Socket_Exception
{
	public:
		...
		const char *what() const { return "Socket_SelectFailed"; }
};
